...
Currently :mod:`petl` supports Python 2.7, 3.4, 3.5, 3.6 and 3.7
...
pass if run with Python 3.7. Doctests can be run with `nose
...
2.7 and 3.7 available on your system.

To run all tests **without** installing any of the optional
dependencies, do::

    $ tox -e py27,py37,doctests
